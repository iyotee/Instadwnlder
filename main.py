...
def is_valid_instagram_url(url):
    """
    Vérifie si l'URL fournie est une URL Instagram valide.
    """
    regex = re.compile(
...
def download_instagram_video(video_url, username, password):
    ...
    """
    # Créer une instance de l'outil Instaloader avec un User-Agent personnalisé
    ...
    # Extraire le shortcode de l'URL
    shortcode = video_url.split("/")[-2]

    try:
        # Obtenir le post à partir du shortcode
...
if __name__ == "__main__":
    ...
    # Demander à l'utilisateur d'entrer le lien de la vidéo Instagram
    while True:
        video_url = input("Entrez le lien de la vidéo Instagram: ").strip()
        if is_valid_instagram_url(video_url):
            break
        else:
            print("URL invalide. Veuillez entrer une URL Instagram valide, par exemple : https://www.instagram.com/p/XXXXXXXXXX/")
